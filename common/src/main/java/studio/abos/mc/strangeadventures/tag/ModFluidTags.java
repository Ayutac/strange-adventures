...
public final class ModFluidTags {
    ...
    public static final TagKey<Fluid> CRUDE_LIVING_SAP = TagKey.create(Registries.FLUID, StrangeAdventures.id("crude_living_sap"));
    ...
    public static final TagKey<Fluid> ANY_LIVING_SAP = TagKey.create(Registries.FLUID, StrangeAdventures.id("any_living_sap"));
